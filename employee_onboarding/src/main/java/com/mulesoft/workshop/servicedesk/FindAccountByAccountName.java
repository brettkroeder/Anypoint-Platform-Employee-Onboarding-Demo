...
@XmlRootElement(name = "findAccountByAccountName")
public class FindAccountByAccountName {

    @XmlElementRef(name = "accountName", namespace = "http://tempuri.org/", type = JAXBElement.class)
